package com.github.docastest.plugin.intellij;

import com.github.docastest.plugin.intellij.approvalFile.ApprovalFile;
import com.github.docastest.plugin.intellij.approvalFile.ApprovedFile;
...
public class ApprovalFileTest {
    ...
    public void create_approval_java_file_from_java_class() throws NoSuchMethodException {
        ApprovalFile filename = ApprovalFile.fromClass("com.github.docastest.plugin.intellij.demo", "DemoTest");
        assertEquals("com/github/docastest/plugin/intellij/demo/DemoTest.java", filename.getName());
    ...
    public void create_approval_java_file_from_java_method_with_string() throws NoSuchMethodException {
        ApprovalFile filename = ApprovalFile.fromMethod("com.github.docastest.plugin.intellij.demo", "DemoTest", "a_simple_test");
        assertEquals("com/github/docastest/plugin/intellij/demo/DemoTest.java", filename.getName());
        assertEquals("DemoTest.java", filename.getFileName());
    }
    ...
    public void convert_from_java_to_approved() throws NoSuchMethodException {
        ...
        assertEquals("com/github/docastest/plugin/intellij/demo/_DemoTest.a_simple_test.approved.adoc", approvedFile.getName());
    ...
    public void get_received_file_from_java_method_with_string() throws NoSuchMethodException {
        ApprovalFile filename = ApprovalFile.fromMethod("com.github.docastest.plugin.intellij.demo", "DemoTest", "a_simple_test");
        assertEquals("com/github/docastest/plugin/intellij/demo/_DemoTest.a_simple_test.received.adoc", filename.to(ApprovalFile.Status.RECEIVED).getName());
    ...
    public void get_approved_file_from_java_method_with_string() throws NoSuchMethodException {
        ApprovalFile filename = ApprovalFile.fromMethod("com.github.docastest.plugin.intellij.demo", "DemoTest", "a_simple_test");
        assertEquals("com/github/docastest/plugin/intellij/demo/_DemoTest.a_simple_test.approved.adoc", filename.to(ApprovalFile.Status.APPROVED).getName());
    }
    ...
    public void open_test_file_with_path() {
        ApprovalFile filename = ApprovalFile.valueOf("com/github/docastest/plugin/intellij/demo/_Test.received.adoc").get();
        assertEquals("com/github/docastest/plugin/intellij/demo/Test.java", filename.getTestFile());
    }

    @Test
    public void open_test_file_with_path_and_underscore() {
        ApprovalFile filename = ApprovalFile.valueOf("com/github/docastest/plugin/intellij/demo/_Test_Underscore.received.adoc").get();
        assertEquals("com/github/docastest/plugin/intellij/demo/Test_Underscore.java", filename.getTestFile());
    }

    @Test
    public void open_test_file_with_path_and_method() {
        ApprovalFile filename = ApprovalFile.valueOf("com/github/docastest/plugin/intellij/demo/_Test.mytestcase.received.adoc").get();
        assertEquals("com/github/docastest/plugin/intellij/demo/Test.java", filename.getTestFile());
    }
    ...
    public void extract_package_from_received_file() {
        ApprovalFile approvalFile = ApprovalFile.valueOf("com/github/docastest/plugin/intellij/demo/_MyClass.received.adoc").get();
        assertEquals("MyClass", approvalFile.getClassName());
        assertEquals(Paths.get("com", "github", "docastest", "plugin", "intellij", "demo"), approvalFile.getPath());
    }
